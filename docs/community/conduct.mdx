...
description: The standards of behaviour we expect from everyone who takes part in the RCP community.
icon: heart
---

RCP adopts the [Contributor Covenant](https://www.contributor-covenant.org).
The full text is condensed below; by participating in the project you agree to
uphold it.
...
[report abuse](https://github.com/1ay1/rcp/issues) channel or by contacting a
