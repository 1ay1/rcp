...
RCP adopts the [Contributor Covenant](https://www.contributor-covenant.org),
version 2.1. This page is the canonical copy; a rendered version appears in the
docs under **Community → Code of Conduct**.

## Our pledge

We as members, contributors, and maintainers pledge to make participation in the
RCP community a harassment-free experience for everyone, regardless of age, body
...
they deem inappropriate, threatening, offensive, or harmful. Maintainers have
the right to remove, edit, or reject comments, commits, code, issues, and other
...
issues, pull requests, and discussions — and also when an individual is
officially representing the community in public spaces.

## Reporting

Instances of abusive, harassing, or otherwise unacceptable behaviour may be
reported to the maintainers privately through GitHub's report-abuse channel or by
